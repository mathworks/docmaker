...
This is DocMaker version 0.6.1.  The [release notes](changelog.md) detail new features, bug fixes, and compatibility considerations for each version.
...
[`docconvert`](docconvert.md) and [`docindex`](docindex.md) require network access to a GitHub or GitLab instance to process your Markdown documents and generate DocMaker artifacts.  By default, DocMaker uses the GitHub Markdown API at `api.github.com` to convert Markdown to HTML.  You can [configure Markdown conversion](conversion.md) to use another converter technology or service instance or to authenticate with an access token.
