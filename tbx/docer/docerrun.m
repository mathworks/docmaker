...
%docerrun  Run MATLAB scripts and capture output
%
%  docerrun(s) runs the MATLAB scripts s and captures figure output to PNG
%  files.
%
%  docerrun(...,"Size",wh) sets the size of the output figures to [width
%  height] wh.
%
