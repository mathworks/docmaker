...
- `/tbx/docstar`: the code
- `/tbx/docstardoc`: the documentation, generated by [DocStar](https://insidelabs-git.mathworks.com/dsampson/docstar)
- `/releases`: the archive of previous MATLAB&reg; toolbox (.mltbx) releases

There are no tests *per se*, but DocStar generates its own documentation, which exercises a wide range of its functionality.
