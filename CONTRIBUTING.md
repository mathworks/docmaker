...
- `/tbx/docmaker`: the code
- `/tbx/docmakerdoc`: the documentation, generated by [DocMaker](https://insidelabs-git.mathworks.com/dsampson/docmaker)
- `/releases`: the archive of previous MATLAB&reg; toolbox (.mltbx) releases

There are no tests *per se*, but DocMaker generates its own documentation, which exercises a wide range of its functionality.

## Guidelines

We support MATLAB versions from R2021a.  Do not use features that require later versions of MATLAB.
