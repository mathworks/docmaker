...
- `/tbx/docer`: the code
- `/tbx/docerdoc`: the documentation, generated by [Doc_er](https://insidelabs-git.mathworks.com/dsampson/docer)
- `/releases`: the archive of previous MATLAB&reg; toolbox (.mltbx) releases

There are no tests *per se*, but Doc_er generates its own documentation, which exercises a wide range of its functionality.
